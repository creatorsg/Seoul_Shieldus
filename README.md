...
- ** 안심지수 히트맵** — 서울시 25개 자치구를 CCTV · 파출소 접근성 · 안심귀갓길 · 가로등 · 범죄안전 5개 지표의 가중합(0~100점)으로 계산한 "안심지수"로 비교합니다. 지도에서 자치구를 호버하면 해당 폴리곤이 강조되고, 랭킹 표와 자치구별 상세 점수 막대, CCTV 목적별 설치 현황 차트를 확인할 수 있습니다.
